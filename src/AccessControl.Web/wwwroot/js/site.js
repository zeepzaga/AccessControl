// Общие улучшения интерфейса: фильтрация чекбокс-списков, поисковых списков и копирование деталей ошибок.
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('[data-copy-error]').forEach((button) => {
        button.addEventListener('click', async () => {
            const selector = button.getAttribute('data-copy-error');
            if (!selector) {
                return;
            }
